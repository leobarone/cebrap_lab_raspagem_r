...
```{html}
//ol[@class='search-results-title'/li/h3/a
```

Poderíamos subir um nível hierárquico para melhorar o "caminho":

```{html}
//div[@class='search-results']/ol[@class='search-results-title'/li/h3/a
```
...
```{r}
nodes_titulos <- html_nodes(pagina, xpath = "//h3/a")
```
